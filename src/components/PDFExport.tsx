...
export const PDFExport = () => {
  ...
  const generatePDFContent = () => {
    ...
    const recurringExpenses = data.expenses.filter(expense => expense.status === 'active' && expense.type === 'recurring');
...
<body>
    <div class="header">
        ...
        <div class="subtitle">Generated for ${data.userProfile.name} on ${currentDate}</div>
                      <div class="subtitle">Numoraq - Personal Finance Tracker</div>
    </div>
    ...
    <div class="section">
        ...
        <div class="subsection">
            <div class="subsection-title">Recurring Expenses (${currency} ${totalRecurringExpenses.toLocaleString()})</div>
        ...
        ${recurringExpenses.length === 0 && variableExpenses.length === 0 ? '<div class="item">No expenses recorded</div>' : ''}
    </div>
    ...
    <div class="footer">
                  <p>Generated by Numoraq - Personal Finance Dashboard</p>
        <p>Currency: ${data.userProfile.defaultCurrency} | Projection Period: ${data.projectionMonths} months</p>
        <p>This report contains ${data.liquidAssets.length + data.illiquidAssets.length} assets, ${data.activeIncome.length + data.passiveIncome.length} income sources, ${recurringExpenses.length + variableExpenses.length} expenses, and ${data.debts.length} debt entries.</p>
    </div>
</body>
</html>
    `;
