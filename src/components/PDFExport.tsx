...
<body>
    ...
    <div class="footer">
        ...
        <p>This report contains ${data.liquidAssets.length + data.illiquidAssets.length} assets, ${data.activeIncome.length + data.passiveIncome.length} income sources, ${data.expenses.length} expenses, and ${data.debts.length} debt entries.</p>
    </div>
</body>
</html>
    `;
