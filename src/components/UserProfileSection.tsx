...
export const UserProfileSection = () => {
  ...
  return <Card className="bg-gradient-to-r from-slate-700 to-slate-800 text-white mb-6">
      ...
      <CardContent className="space-y-3 py-[7px]">
        ...
        <div className="flex items-center gap-2">
          ...
          name: String(value)
        })} type="text" placeholder={displayName} className="text-white bg-white/20 hover:bg-white/30" />
        </div>
        <div className="flex items-center gap-2">
          <span className="text-sm">Default Currency:</span>
          <EditableValue value={data.userProfile.defaultCurrency} onSave={handleCurrencyUpdate} type="text" className="text-white bg-white/20 hover:bg-white/30" />
        </div>
      </CardContent>
    </Card>;
};