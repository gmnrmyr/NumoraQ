...
const nftPlaceholders = [
  { id: 'nft1', name: 'NFT #1337', locked: false, rarity: 'Legendary' },
  { id: 'nft2', name: 'NFT #4269', locked: true, rarity: 'Epic' },
  { id: 'nft3', name: 'NFT #888', locked: true, rarity: 'Rare' },
  { id: 'nft4', name: 'NFT #0001', locked: true, rarity: 'Mythic' },
  { id: 'nft5', name: 'NFT #999', locked: true, rarity: 'Common' },
  { id: 'nft6', name: 'NFT #42', locked: true, rarity: 'Uncommon' }
];
