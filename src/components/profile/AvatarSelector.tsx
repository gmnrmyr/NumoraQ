...
const nftPlaceholders = [
  { id: 'nft1', name: 'Digital Punk #1337', locked: false, rarity: 'Legendary' },
  { id: 'nft2', name: 'Cyber Ape #4269', locked: true, rarity: 'Epic' },
  { id: 'nft3', name: 'Cool Cat #888', locked: true, rarity: 'Rare' },
  { id: 'nft4', name: 'Degen #0001', locked: true, rarity: 'Mythic' },
  { id: 'nft5', name: 'Ocean #999', locked: true, rarity: 'Common' },
  { id: 'nft6', name: 'Pixel Punk #42', locked: true, rarity: 'Uncommon' }
];
