...
export const DashboardHeader = () => {
  ...
  // Load UnicornStudio animation for Black Hole theme
  React.useEffect(() => {
    if (isBlackHoleTheme && isAnimationEnabled && !animationPaused) {
  ...
  }, [isBlackHoleTheme, isAnimationEnabled, animationPaused]);
  
  // Force re-initialization when animation becomes visible
  React.useEffect(() => {
    if (animationLoaded && isBlackHoleTheme && isAnimationEnabled && !animationPaused) {
  ...
  }, [animationLoaded, isBlackHoleTheme, isAnimationEnabled, animationPaused]);
  
  return (
    <div className="relative">
      {/* UnicornStudio Animation Background for Black Hole theme */}
      {isBlackHoleTheme && isAnimationEnabled && !animationPaused && (
      ...
      <div className="text-center space-y-6 py-8 relative z-10">
        {/* Animation Controls for Black Hole theme */}
        {isBlackHoleTheme && (
